  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <header className="fixed top-4 left-0 right-0 z-50 flex justify-center px-4">
        <nav className="relative flex w-full max-w-5xl h-16 items-center justify-between px-6 rounded-xl border border-hairline bg-canvas/90 backdrop-blur-sm shadow-soft">
          ...
          <div ref={menuRef} className="flex items-center gap-3">
            ...
            <button
              ...
              className="w-9 h-9 rounded-full border border-hairline hover:bg-surface-soft transition-all duration-150 flex items-center justify-center cursor-pointer outline-none sm:hidden"
            ...
            {menuOpen && (
              <div className="absolute top-full right-0 mt-2 w-56 rounded-xl border border-hairline bg-canvas/95 backdrop-blur-md shadow-soft py-2 animate-fade-in sm:hidden">
                <Link
                  ...
                  className="block px-4 py-2.5 text-sm text-body hover:text-ink hover:bg-surface-soft transition-colors"
                >
                  Sobre o Projeto
                </Link>
                ...
                <a
                  ...
                  onClick={() => setMenuOpen(false)}
                  className="flex items-center gap-3 px-4 py-2.5 text-sm text-body hover:text-ink hover:bg-surface-soft transition-colors"
                >
                ...
                {isAuthenticated ? (
                  <>
                    <span className="block px-4 py-2 text-xs text-muted">{user?.name}</span>
                    <button
                      type="button"
                      onClick={() => { logout(); setMenuOpen(false) }}
                      className="w-full text-left px-4 py-2.5 text-sm text-body hover:text-ink hover:bg-surface-soft transition-colors"
                    >
                      Sair
                    </button>
                  </>
                  ...
                  <>
                    ...
                    <Link
                      to="/register"
                      onClick={() => setMenuOpen(false)}
                      className="block px-4 py-2.5 text-sm font-semibold text-primary hover:text-primary-active hover:bg-surface-soft transition-colors"
                    >
                      Cadastrar
                    </Link>
                  </>
