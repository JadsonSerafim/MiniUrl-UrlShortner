  ...
  return (
    <section className="mx-auto max-w-6xl px-4 py-10 flex flex-col gap-8">
      <div className="flex items-start justify-between">
        ...
        <Link
          to="/settings"
          className="flex items-center gap-2 px-3 py-2 rounded-lg text-xs font-medium text-muted hover:text-ink hover:bg-surface-soft transition-colors border border-hairline"
        >
